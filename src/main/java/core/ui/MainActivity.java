...
//        pluginMenu = new JMenu("插件");
    ...
    private void initVariable() {
        this.setTitle(EasyI18N.getI18nString("TYR哥斯拉   V%s by: BJSec安全分析组 ", new Object[]{"4.x"}));
...
//        menuBar.add(pluginMenu);
    ...
    private void aboutMenuItemClick(ActionEvent e) {
        GOptionPane.showMessageDialog(getFrame(), EasyI18N.getI18nString("由BJSec安全分析组驱动\n"), "About", -1);
    }
